...
png(filename = "edgestrianglemaxCC1000.png", ##### Ir cambiando el nombre #####
    width = 1920, height = 1500,         
    units = "px",                        
res = 300) 

#Aqui pones el CSV que quieres leer (SIEMPRE EL DE N_1000)
data1 <- read.csv("n_1000_maxCC_edges_triangles.csv")
...
plot(X, Y1, 
     type = "l",                    
     main = "Relació entre la mida del clúster més gran i la prob. q, H = 1000",  
     xlab = "Prob. q",                        
